...
id: generate_omim_database_for_annotated
baseCommand:
  - python
  - OMIM_generate.py
inputs:
...
outputs:
  - id: Generated_output
    ...
    outputBinding:
      glob: '*.csv'
label: Generate_OMIM_database_for_annotated
requirements:
    ...
    listing:
      - entryname: OMIM_generate.py
        entry: >-
          ...
          ##  uniq the omim datasate and add chinesed omim description in to
          colums, generate the format that we need 
          ...
          res_name='./OMIM_'+ get_date.year + '_' + get_date.month + '_' +
          get_date.day + '.csv' 
